...
--
-- Servidor: localhost
-- Tiempo de generación: 02-11-2023 a las 22:43:10
...
--
-- Base de datos: `bomberosG37`
--
CREATE DATABASE IF NOT EXISTS `bomberosG37` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bomberosG37`;
...
(8, '1', 'Soto Carlos', '1982-04-20', '12344567', 1, 'A+', 0),
(9, '2', 'Soto Pablo', '1982-04-21', '12344567', 1, 'A-', 0),
...
(13, '6', 'Carlos Sanchez', '1984-04-15', '34125', 2, 'A-', 0),
(15, '7', 'Juan Perez', '1985-07-12', '12345678', 3, 'A+', 1),
(16, '8', 'Maria Rodriguez', '1982-09-28', '23456789', 12, 'A-', 0),
...
(28, '20', 'Isabel Vargas', '1988-09-09', '56785678', 4, 'A+', 0),
(29, '21', 'Jorge Paredes', '1980-03-26', '67896789', 13, 'AB-', 1),
(30, '22', 'Natalia Rojas', '1975-11-11', '78907890', 6, 'A-', 0),
...
(35, '27', 'Fernando Navarro', '1976-04-03', '34562345', 14, 'A-', 1),
...
(39, '31', 'Roberto Castro', '1973-09-13', '78906789', 1, 'A+', 1),
(40, '32', 'Camila Montes', '1985-07-01', '89017890', 10, 'A-', 0),
(41, '33', 'Gustavo Varela', '1979-03-19', '90128901', 5, 'AB+', 1),
(42, '34', 'Natalie Peralta', '1988-11-16', '12341234', 2, 'A-', 0),
(43, '35', 'Sebastian Soto', '1977-05-03', '23452345', 13, 'A+', 1),
(44, '36', 'Valeria Salazar', '1982-01-20', '34563456', 8, 'A-', 0),
...
(6, 'tfuytr', '4dgu5', 10, 15, '78687687', 'gfdghfdh', 1);
...
(150, 'Incendio', '2023-10-31', 20, 45, 'Testing null', NULL, 5, 1, 0, 1);
...
--
ALTER TABLE `siniestro`
  MODIFY `codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;

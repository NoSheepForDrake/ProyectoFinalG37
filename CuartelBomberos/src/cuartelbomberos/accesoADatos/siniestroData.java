...
public class siniestroData {
    ...
    public void guardarSiniestro(Siniestro sini) {
        ...
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "No se puede acceder a la tabla siniestros. " + ex.getMessage());
        }
    }
    ...
    public void eliminarSiniestro(int cod) {
        ...
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "No se puede acceder a la tabla siniestro. " + ex.getMessage());
        }
